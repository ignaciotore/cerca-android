const CACHE='cerca-web-v51';
const STATIC=['/','/index.html','/styles.css','/app.js','/contact-role-fix.js','/notification-flow-fix.js','/network-invite-cleanup.js','/notification-permission.js?v=50','/web-push-fix.js','/emergency-runtime-fix.js?v=42','/location-onboarding.js?v=50','/ios-shortcut-call.js?v=50','/ios-shortcut-config.json','/android-auto-call-watchdog.js?v=41','/pwa.js?v=51','/manifest.webmanifest','/icon.svg'];
