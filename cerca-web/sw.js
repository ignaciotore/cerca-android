const CACHE='cerca-web-v18';
const STATIC=['/','/index.html','/styles.css','/app.js','/contact-role-fix.js','/notification-flow-fix.js','/notification-permission.js','/pwa.js','/manifest.webmanifest','/icon.svg'];
