const CACHE='cerca-web-v58';
const STATIC=['/','/index.html','/styles.css','/app.js','/active-emergency-owner-fix.js?v=1','/contact-role-fix.js','/notification-flow-fix.js','/network-invite-cleanup.js','/medical-access-fix.js?v=1','/notification-permission.js?v=50','/web-push-fix.js','/emergency-runtime-fix.js?v=42','/location-onboarding.js?v=50','/ios-shortcut-call.js?v=51','/ios-shortcut-config.json','/android-auto-call-watchdog.js?v=41','/pwa.js?v=55','/manifest.webmanifest','/icon.svg'];
